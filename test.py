...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/rzx/rzx.data', help='*.data path')
    parser.add_argument('--weights', type=str, default='weights/2020.07.15/best.pt', help='weights path')
