...
class DarkNetParser(object):
    ...
    def parse_cfg_file(self, cfg_file_path):
        ...
        return self.layer_configs, self.yolo_layer_index
    ...
    def _next_layer(self, remainder):
        ...
        elif layer_type == 'yolo' and self.yolo_layer_index == -1:
            self.yolo_layer_index = self.layer_counter
...
class GraphBuilderONNX(object):
    ...
    def __init__(self, output_tensors, yolo_layer_index):
        ...
        self.batch_size = 1
        self.yolo_layer_index = yolo_layer_index
    ...
    def _make_route_node(self, layer_name, layer_dict):
        ...
        #     if len(self.major_node_specs) >= self.yolo_layer_index:
        #         split_index += 1
    ...
    def _make_maxpool_node(self, layer_name, layer_dict):
        ...
        strides = [stride, stride]
        pads = [padding_size, padding_size, padding_size, padding_size]
...
def main():
    ...
    layer_configs, yolo_layer_index = parser.parse_cfg_file(cfg_file_path)
    ...
    output_tensor_dims['089_convolutional'] = [180, 19, 19]
    output_tensor_dims['101_convolutional'] = [180, 38, 38]
    output_tensor_dims['113_convolutional'] = [180, 76, 76]

    # Create a GraphBuilderONNX object with the known output tensor dimensions:
    builder = GraphBuilderONNX(output_tensor_dims, yolo_layer_index)
    ...
    weights_file_path = "./weights/2020.07.15/best.weights"
